...
import org.apache.spark.ml.utils.Utils.times
import org.apache.spark.ml.utils.XORShiftRandom

class XORShiftRandomSuite extends SparkMLFunSuite with Matchers {
